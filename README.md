...
[![Google Gemini AI](https://img.shields.io/badge/Google_Gemini_AI-1.5_Flash-4285F4?logo=google&logoColor=white)](https://aistudio.google.com/)
...
- **In-App API Key Manager**: Support for free Google AI Studio API key via `.env` (`VITE_GEMINI_API_KEY`) or interactive UI settings modal.
...
cd AI-Powered_ATS-Resume-Builder

# 2. Install dependencies
npm install

# 3. Create .env file (Optional - you can also input key inside the app UI)
echo "VITE_GEMINI_API_KEY=your_free_gemini_key_here" > .env
